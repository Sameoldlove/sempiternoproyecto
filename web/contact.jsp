   ...
   <!--/contact-->
    <div class="banner_bottom_agile_info">
		  ...
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w31">
							...
							<h4>Address</h4>
							<p>Calle 102  No. 74 A 47<span>Medellin,Colombia.</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w32">
							...
							<h4>Call Us</h4>
							<p><span>+57 3127853385 - +57 3225069006</span></p>
						</div>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:info@example.com">sempiterno@maildrop.cc</a><span><a href="mailto:info@example.com"></a></span></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
	   ...
	   <div class="contact-w3-agile1 map" data-aos="flip-right">
		   ...
		   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d105268.14469871746!2d-75.65125272089928!3d6.244369472344651!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e4428dfb80fad05%3A0x42137cfcc7b53b56!2sMedell%C3%ADn%2C+Antioquia%2C+Colombia!5e1!3m2!1ses!2ses!4v1506610536985" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
	   </div>
   <div class="banner_bottom_agile_info">
	<div class="container">
						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>+57 3127853385 - +57 3225069006</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:info@example.com">sempiterno@maildrop.cc</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Location</p><span>Calle 102 No. 74 A 4 </span>
								</div>
								<div class="clearfix"> </div>
							</div>
